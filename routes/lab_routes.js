...
var loginBool = require("./login_routes");
                                ...
                                where: {
                                   ...
                                   if (result.length == selectGroupLimit) {
                                    ...
                                    listOfEmails = listOfEmails.slice(0, (listOfEmails.length - 2));
                                        ...
                                        var mailOptions = {
                                            from: '"theLab Team 👻" <theLab225@gmail.com>', // sender address
                                            to: listOfEmails, // list of receivers
                                            subject: 'theLab COLLABORATION!', // Subject line
                                            text: 'Hi! Let\'s work together!', // plain text body
                                            html: '<b>Hi! Let\'s work together!</b><p>This is an official email from theLab Dev!</p><p>Your group\'s project description is written below: </p>' + '"'+emailBody+'"'
                                        };
